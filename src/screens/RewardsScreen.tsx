...
export function RewardsScreen() {
  return (
    <View className="flex-1 bg-kemix-bg">
      <SafeAreaView edges={['top']} className="border-b border-kemix-border bg-kemix-surface px-4 pb-3">
        <Text className="text-xl font-bold text-kemix-text">리워드</Text>
        <Text className="mb-3 text-sm text-kemix-text-secondary">출석 · 퀴즈 · 포인트 적립</Text>
        <AccountBar />
        <View className="mt-3">
          <WalletHeader />
        </View>
